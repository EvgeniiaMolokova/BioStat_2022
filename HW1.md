...
График типа “ящик с усами” дает визуальное представление о разнице
средних и размахе значений переменной “ИМТ” в двух подгруппах, так что в
нашем случае мы можем предположить, что различия по данному показателю
будут не значимы (среднее значение в одной подгруппе в пределах IQR
другой подгруппы).
